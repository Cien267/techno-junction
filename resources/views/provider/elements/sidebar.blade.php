<div class="sidebar-inner slimscroll">
    <div id="sidebar-menu" class="sidebar-menu">
        <ul>
            <li class="active">
                <a href="{{ route('provider.dashboard') }}"><i class="feather-grid"></i> <span>Dashboard</span></a>
            </li>
{{--            <li>--}}
        ...
        <div class="menu-bottom">
            <div class="menu-user">
                <div class="menu-user-img avatar-online">
                    <img src="img/avatar-02.jpg" alt="user">
                </div>
                <div class="menu-user-info">
                    <h6>John Smith</h6>
                    <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5e343136302d33372a361e3b263f332e323b703d3133">[email&#160;protected]</a></p>
                </div>
            </div>
