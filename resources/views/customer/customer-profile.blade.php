            ...
            <div class="pro-picture">
                ...
                <div class="pro-info">
                    <div class="d-flex">
                        ...
                        <a href="#" class="btn btn-remove"  data-toggle="modal" data-target="#del-account">Remove</a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="2" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-z5wo-container"><span class="select2-selection__rendered" id="select2-z5wo-container" role="textbox" aria-readonly="true" title="Select Gender">Select Gender</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
