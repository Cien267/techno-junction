...
<div class="breadcrumb-bar">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="breadcrumb-title mb-0">John Smith</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row align-items-center">
            <div class="col-md-5">
                <div class="provider-img">
                    <img src="/frontend/images/provider-1.png" class="img-fluid" alt="img">
            ...
            <div class="col-md-7">
                <div class="provider-info">
                    <h2>John Smith</h2>
                    <h5>Carpenter</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo dolor in reprehenderit in voluptate consequat. </p>
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="provide-box">
                                ...
                                <div class="provide-info">
                                    <h6>Email</h6>
                                    <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ec988483818d9f84ac89948d819c8089c28f8381">[email&#160;protected]</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="social-icon provide-social">
                                <ul>
                                    <li>
                                        <a href="#" target="_blank"><i class="feather-instagram me-0"></i> </a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank"><i class="feather-twitter me-0"></i> </a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank"><i class="feather-youtube me-0"></i></a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank"><i class="feather-linkedin me-0"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
