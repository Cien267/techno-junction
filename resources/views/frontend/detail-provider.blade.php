                    ...
                    <div class="row gx-2">
                        <div class="col-md-9">
                            <div class="service-images big-gallery">
                                <img src="/frontend/images/service-ban-01.jpg" class="img-fluid" alt="img">
                                <a href="/frontend/images/service-ban-01.jpg" data-fancybox="gallery" class="btn btn-show"><i class="feather-image me-2"></i>Show all photos</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="service-images small-gallery">
                                <a  href="/frontend/images/service-ban-02.jpg" data-fancybox="gallery">
                                    <img src="/frontend/images/service-ban-02.jpg" class="img-fluid" alt="img">
                                    <span class="circle-icon"><i class="feather-plus"></i></span>
                                </a>
                            </div>
                            <div class="service-images small-gallery">
                                <a  href="/frontend/images/service-ban-03.jpg" data-fancybox="gallery">
                                    <img src="/frontend/images/service-ban-03.jpg" class="img-fluid" alt="img">
                                    <span class="circle-icon"><i class="feather-plus"></i></span>
                                </a>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="service-wrap">
                    ...
                    <p>Car wash is a facility used to clean the exterior and, in some cases, the interior of motor vehicles. Car washes can be self-serve, fully automated, or full-service with attendants who wash the vehicle.</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="provide-box">
                                <img src="/frontend/images/avatar-02.jpg" class="img-fluid" alt="img">
                        ...
                        <div class="col-md-4">
                            <div class="provide-box">
                                ...
                                <div class="provide-info">
                                    <h6>Email</h6>
                                    <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="81f5e9eeece0f2e9c1e4f9e0ecf1ede4afe2eeec">[email&#160;protected]</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="service-wrap">
                    ...
                    <div class="owl-carousel gallery-slider">
                        <div class="gallery-widget">
                            <a href="/frontend/images/gallery-big-01.jpg" data-fancybox="gallery">
                                <img class="img-fluid" alt="Image" src="/frontend/images/gallery-01.jpg">
                            </a>
                        </div>
                        <div class="gallery-widget">
                            <a href="/frontend/images/gallery-big-02.jpg" data-fancybox="gallery">
                                <img class="img-fluid" alt="Image" src="/frontend/images/gallery-02.jpg">
                            </a>
                        </div>
                        <div class="gallery-widget">
                            <a href="/frontend/images/gallery-big-03.jpg" data-fancybox="gallery">
                                <img class="img-fluid" alt="Image" src="/frontend/images/gallery-03.jpg">
                            </a>
                        </div>
                        <div class="gallery-widget">
                            <a href="/frontend/images/gallery-02.jpg" data-fancybox="gallery">
                                <img class="img-fluid" alt="Image" src="/frontend/images/gallery-02.jpg">
                            </a>
                        </div>
                    </div>
                ...
                <div class="service-wrap">
                    ...
                    <div id="background-video">
                        <a class="play-btn" data-fancybox="" href="https://www.youtube.com/watch?v=Vdp6x7Bibtk"><i class="fa-solid fa-play"></i></a>
                    </div>
                </div>
                <div class="service-wrap">
                    <h5>Reviews</h5>
                    <ul>
                        <li class="review-box">
                            ...
                            <div class="recommend-item">
                                <a href="#"><img alt="Image" src="/frontend/images/reply-icon.svg" class="me-2"> Reply</a>
                        ...
                        <li class="review-box">
                            <div class="review-profile">
                                <div class="review-img">
                                    <img src="/frontend/images/avatar-03.jpg" class="img-fluid" alt="img">
                                    <div class="review-name">
                                        <h6>Jaime</h6>
                        ...
                        <li class="review-box">
                            <div class="review-profile">
                                <div class="review-img">
                                    <img src="/frontend/images/avatar-07.jpg" class="img-fluid" alt="img">
                                    <div class="review-name">
                                        <h6>Martinez</h6>
                        ...
                        <li class="review-box">
                            <div class="review-profile">
                                <div class="review-img">
                                    <img src="/frontend/images/avatar-05.jpg" class="img-fluid" alt="img">
                                    <div class="review-name">
                                        <h6>Bradley</h6>
                    ...
                    <div class="text-center">
                        <a href="../customer/customer-reviews.html" class="btn btn-primary btn-review">View All Reviews</a>
                    </div>
                </div>
                ...
                <div class="owl-carousel related-slider">
                    ...
                    <div class="service-widget mb-0">
                        <div class="service-img">
                            <a href="service-details.html">
                                <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-01.jpg">
                            </a>
                            <div class="fav-item">
                            ...
                            <div class="item-info">
                                <a href="../provider/providers.html"><span class="item-img"><img src="/frontend/images/avatar-04.jpg" class="avatar" alt="User"></span></a>
                            </div>
                        </div>
                    ...
                    <div class="service-widget mb-0">
                        <div class="service-img">
                            <a href="service-details.html">
                                <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-02.jpg">
                            </a>
                            <div class="fav-item">
                            ...
                            <div class="item-info">
                                <a href="../provider/providers.html"><span class="item-img"><img src="/frontend/images/avatar-03.jpg" class="avatar" alt="User"></span></a>
                            </div>
                        </div>
                        <div class="service-content">
                            <h3 class="title">
                    ...
                    <div class="service-widget mb-0">
                        <div class="service-img">
                            <a href="service-details.html">
                                <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-03.jpg">
                            </a>
                            <div class="fav-item">
                            ...
                            <div class="item-info">
                                <a href="../provider/providers.html"><span class="item-img"><img src="/frontend/images/avatar-02.jpg" class="avatar" alt="User"></span></a>
                            </div>
                        </div>
                        <div class="service-content">
                            <h3 class="title">
                            ...
                            <ul>
                                    ...
                                    <div class="add-serving">
                                        ...
                                        <div class="add-serv-item">
                                            <div class="add-serv-img">
                                                <img src="/frontend/images/service-09.jpg" alt="image">
                                            </div>
                                ...
                                <li>
                                    <div class="add-serving">
                                        ...
                                        <div class="add-serv-item">
                                            <div class="add-serv-img">
                                                <img src="/frontend/images/service-16.jpg" alt="image">
                                            </div>
                                            <div class="add-serv-info">
                                ...
                                <li>
                                    <div class="add-serving">
                                        ...
                                        <div class="add-serv-item">
                                            <div class="add-serv-img">
                                                <img src="/frontend/images/service-07.jpg" alt="Service">
                                            </div>
                                            <div class="add-serv-info">
                                ...
                                <li>
                                    <div class="add-serving">
                                        ...
                                        <div class="add-serv-item">
                                            <div class="add-serv-img">
                                                <img src="/frontend/images/service-03.jpg" alt="Service Image">
                                            </div>
                                            <div class="add-serv-info">
