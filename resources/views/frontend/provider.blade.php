                ...
                <div class="row">
                        ...
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                <a href="service-details.html">
                                    <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-04.jpg">
                                </a>
                                <div class="fav-item">
                                ...
                                <div class="item-info">
                                    <a href="providers.html"><span class="item-img"><img src="/frontend/images/avatar-01.jpg" class="avatar" alt="User"></span></a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                <a href="service-details.html">
                                    <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-06.jpg">
                                </a>
                                <div class="fav-item">
                                ...
                                <div class="item-info">
                                    <a href="providers.html"><span class="item-img"><img src="/frontend/images/avatar-02.jpg" class="avatar" alt="User"></span></a>
                                </div>
                            </div>
                            <div class="service-content">
                                <h3 class="title">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                <a href="service-details.html">
                                    <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-07.jpg">
                                </a>
                                <div class="fav-item">
                                ...
                                <div class="item-info">
                                    <a href="providers.html"><span class="item-img"><img src="/frontend/images/avatar-03.jpg" class="avatar" alt="User"></span></a>
                                </div>
                            </div>
                            <div class="service-content">
                                <h3 class="title">
                                ...
                                <p><i class="feather-map-pin"></i>Maryland, USA<span class="rate"><i class="fas fa-star filled"></i>4.9</span></p>
                                <div class="serv-info">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                <a href="service-details.html">
                                    <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-08.jpg">
                                </a>
                                <div class="fav-item">
                                    <a href="categories.html"><span class="item-cat">Car Wash</span></a>
                                    <a href="javascript:void(0)" class="fav-icon">
                                ...
                                <div class="item-info">
                                    <a href="providers.html"><span class="item-img"><img src="/frontend/images/avatar-04.jpg" class="avatar" alt="User"></span></a>
                                </div>
                            </div>
                            <div class="service-content">
                                <h3 class="title">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                ...
                                <div class="item-info">
                                    <a href="providers.html"><span class="item-img"><img src="/frontend/images/avatar-05.jpg" class="avatar" alt="User"></span></a>
                                </div>
                            </div>
                            <div class="service-content">
                                <h3 class="title">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                <a href="service-details.html">
                                    <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-09.jpg">
                                </a>
                                <div class="fav-item">
                            ...
                            <div class="service-content">
                                ...
                                <p><i class="feather-map-pin"></i>Georgia<span class="rate"><i class="fas fa-star filled"></i>4.9</span></p>
                                <div class="serv-info">
                                    <h6>$10.00</h6>
                                    <a href="booking.html" class="btn btn-book">Book Now</a>
                                </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                <a href="service-details.html">
                                    <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-05.jpg">
                                </a>
                                <div class="fav-item">
                                    <a href="categories.html"><span class="item-cat">Construction</span></a>
                                    <a href="javascript:void(0)" class="fav-icon">
                                ...
                                <div class="item-info">
                                    <a href="providers.html"><span class="item-img"><img src="/frontend/images/avatar-06.jpg" class="avatar" alt="User"></span></a>
                                </div>
                            </div>
                            <div class="service-content">
                                <h3 class="title">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                <a href="service-details.html">
                                    <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-10.jpg">
                                </a>
                                <div class="fav-item">
                                    <a href="categories.html"><span class="item-cat">Construction</span></a>
                                    <a href="javascript:void(0)" class="fav-icon">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                <a href="service-details.html">
                                    <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-11.jpg">
                                </a>
                                <div class="fav-item">
                                    <a href="categories.html"><span class="item-cat">Plumbing</span></a>
                                    <a href="javascript:void(0)" class="fav-icon">
                                        <i class="feather-heart"></i>
                                    </a>
                                </div>
                                <div class="item-info">
                                    <a href="providers.html"><span class="item-img"><img src="/frontend/images/avatar-07.jpg" class="avatar" alt="User"></span></a>
                                </div>
                            </div>
                            <div class="service-content">
                                <h3 class="title">
                                ...
                                <p><i class="feather-map-pin"></i>Virginia, USA<span class="rate"><i class="fas fa-star filled"></i>4.9</span></p>
                                <div class="serv-info">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="service-widget servicecontent">
                            <div class="service-img">
                                <a href="service-details.html">
                                    <img class="img-fluid serv-img" alt="Service Image" src="/frontend/images/service-13.jpg">
                                </a>
                                <div class="fav-item">
                                    <a href="categories.html"><span class="item-cat">Construction</span></a>
                                    <a href="javascript:void(0)" class="fav-icon">
                            ...
                            <div class="service-content">
                                <h3 class="title">
                                    <a href="service-details.html">Painting Services</a>
                                </h3>
                            ...
                            <nav>
                                <ul class="pagination justify-content-center mt-0">
                                    <li class="page-item disabled">
                                        <a class="page-link page-prev" href="javascript:void(0);" tabindex="-1"><i class="fa-solid fa-arrow-left me-1"></i> PREV</a>
                                    </li>
                                    ...
                                    <li class="page-item">
                                        <a class="page-link page-next" href="javascript:void(0);">NEXT <i class="fa-solid fa-arrow-right ms-1"></i></a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
